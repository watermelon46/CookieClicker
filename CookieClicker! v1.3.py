...
while True:
        ...
        if userinput=="":
            ...
            promocode=input("Input promo code: ")
            ...
            if promocode=="DM Craft" and dmc==0:
                coins+=5
                print("Promo code activated!")
                dmc=1
            elif promocode=="AUG Storm (Minimal Wear)" and aug==0:
                coins+=0.25
                print("Promo code activated!")
                aug=1
            elif promocode=="0824" and tag==0:
                coins+=0.25
                print("Promo code activated!")
                tag=1
            elif promocode=="CreeperBot" and bot==0:
                coins+=0.25
                print("Promo code activated!")
                bot=1
            else:
                print("The promo code has already been activated or there is no such promo code!")