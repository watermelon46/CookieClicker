...
device=input("What is yor device (pc or mobile)? ")
if device!="mobile" and device!="pc":
    print("Restarn game and select one of the suggested device.")
